...
export const SCHEMAS: Record<ContentKey, Field[]> = {
  ...
  about: [
    ...
    { key: 'bio', label: 'Biography paragraphs', type: 'paragraphs', help: 'Add a link with [text](https://example.com).' },
  ...
  research: [
    { key: 'heading', label: 'Section heading', type: 'text' },
    { key: 'intro', label: 'Section intro', type: 'textarea', rows: 3, help: 'Shown under the Research heading. Links: [text](https://…).' },
    {
      key: 'items',
